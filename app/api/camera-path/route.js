...
const SYSTEM_PROMPT = [
    ...
    'Each direction is 90-150 words of professional cinematography covering',
    'only that clip\'s slice of the path, at that clip\'s pacing. Name the',
    'move family precisely (track, dolly, pan, tilt, crane, arc, push in,',
    'pull back, ease out) AND make it specific: where the camera starts',
    'relative to the subject, its height and distance, the lens feel',
    '(wide/normal/long), how fast it travels and where it accelerates or',
    'settles, what enters or leaves frame as it moves, how the subject sits',
    'in the composition through the move, and how the shot resolves on its',
    'final beat. Write it as continuous prose a camera operator could',
    'execute, not a list of terms.',
